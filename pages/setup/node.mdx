...
1. **Download the Installer**:
   - Download the macOS installer (.pkg) file from the [Node.js website](https://nodejs.org/)【14†source】.
...
2. **Install Node.js**:
   ...
   - For Ubuntu, run the following commands:
     ...
     ```
   - You can replace `setup_14.x` with the setup script for the version of Node.js you wish to install【18†source】.
